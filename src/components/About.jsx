...
//             <a href="https://www.linkedin.com/in/Tarun-kale" 
//                className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full transition-transform transform hover:scale-105 mx-2">
//               Check My Certificates
//             </a>
//             <a href="mailto:your.email@example.com" 
//                className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full transition-transform transform hover:scale-105 mx-2">
//               Contact Me
//             </a>
//           </div>
//         </div>
...
//           <div className="text-center mt-8">
//             <a href="https://www.linkedin.com/in/Tarun-kale" 
//                className="bg-gradient-to-r from-green-400 via-teal-500 to-blue-500 text-white font-bold py-2 px-4 rounded-full shadow-md transition-transform transform hover:scale-105 mx-2">
//               Check My Certificates
//             </a>
//             <a href="mailto:your.email@example.com" 
//                className="bg-gradient-to-r from-green-400 via-teal-500 to-blue-500 text-white font-bold py-2 px-4 rounded-full shadow-md transition-transform transform hover:scale-105 mx-2">
