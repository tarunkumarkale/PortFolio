...
const AboutMe = () => {
  ...
  return (
    <div className="p-8 bg-black" id="aboutme">
      <h2 className="text-5xl font-bold mb-[-4%] text-green-500 text-center ">About Me</h2>
      <div className="flex flex-col md:flex-row items-center justify-between">
        ...
        >
          ...
          <p className="text-lg mb-4 text-green-400">
          Currently, I am advancing my expertise through BE 10X, delving into AI tools and prompt engineering to stay at the forefront of web development trends. I showcase my latest projects on GitHub and actively engage with the developer community on LinkedIn, demonstrating my commitment to continuous learning and professional growth
          </p>
        </div>
      </div>
    </div>
